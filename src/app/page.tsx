...
import { DoorOpen, CalendarDays, LayoutDashboard, Heart, Compass } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-5xl">
          ...
          <Card className="relative group overflow-hidden rounded-3xl shadow-lg border-none bg-white/80 dark:bg-slate-800/70 backdrop-blur-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] flex flex-col justify-between">
            ...
            <CardContent className="relative z-10 flex flex-col sm:flex-row justify-center gap-3 p-6 pt-0">
              <Button asChild variant="default" className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium shadow">
                <Link href="/bookings/fobia">Fobia</Link>
              </Button>
              <Button asChild variant="default" className="bg-purple-600 hover:bg-purple-700 text-white font-medium shadow">
                <Link href="/bookings/action-gates">Action Gates</Link>
              </Button>
              <Button asChild variant="outline" className="text-slate-700 dark:text-slate-200 font-medium shadow-sm">
                <Link href="/bookings">Todas las salas</Link>
              </Button>
            </CardContent>
          </Card>
